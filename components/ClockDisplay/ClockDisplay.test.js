...
describe('ClockDisplay Component', () => {
    ...
    const component = <ClockDisplay dateTime={date} timeFontSize={20} dateFontSize={20} dateFormat={'DD/MM/YYYY'}
                                    timeFormat={'HH:mm:ss A'} dateFontFamily={'normal'} timeFontFamily={'normal'}
                                    dateFontColor={'#000000'} timeFontColor={'#000000'} zone={0}/>
